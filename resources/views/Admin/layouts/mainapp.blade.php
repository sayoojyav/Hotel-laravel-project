...
<head>
  ...
  <title>Hotel Management - @yield('tittle')  </title>
...
<body class="">
  <div class="wrapper ">
    ...
    -->
      <div class="logo">
        <a href="{{asset('http://www.creative-tim.com" class="simple-text logo-normal')}}">
          Creative Tim
        </a>
      </div>
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          $.each(obj,function(k1,v1)
            {
              var option = v1.parent_id;
              if(option =='1')
              {
                item +="<option value='"+v1.id+"'>"+v1.subcategory_list+"</option>";
              }
              if(option =='2')
              {
                item +="<option value='"+v1.id+"'>"+v1.subcategory_list+"</option>";
